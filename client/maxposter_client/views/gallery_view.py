...
class GalleryView(ctk.CTkFrame):
    ...
    def _build_top_bar(self):
        ...
        if self.master_app.settings.get("is_admin", False):
            ctk.CTkButton(
                bar, text="Kelola Pengguna", width=140, fg_color="transparent", border_width=1,
    ...
    def _build_grid_area(self):
        ...
        #
        # CATATAN PENTING: add="+" WAJIB di sini. CTkScrollableFrame secara
        # internal SUDAH bind("<Configure>", ...) pada dirinya sendiri untuk
        # memperbarui scrollregion (area yang bisa di-scroll) setiap kali isi
        # bertambah. Tanpa add="+", .bind() bawaan Tkinter MENIMPA binding
        # internal itu -- akibatnya scrollregion berhenti diperbarui begitu
        # poster bertambah banyak (mis. pilih tampilkan 50/100), sehingga
        # sebagian besar konten tidak bisa di-scroll ke bawah sama sekali.
        self._resize_after_id = None
        self.scroll_frame.bind("<Configure>", self._on_grid_configure, add="+")
    ...
    def _open_admin_dialog(self):
        ...
        UserAdminDialog(self.master_app)
