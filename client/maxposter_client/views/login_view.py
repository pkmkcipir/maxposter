...
class LoginView(ctk.CTkFrame):
    def __init__(self, master, on_success):
        ...
        self.error_label = ctk.CTkLabel(container, text="", text_color="#e74c3c", wraplength=320)
    ...
    def _submit(self):
        ...
        if not server_url or not username or not password:
            self.error_label.configure(text="Mohon lengkapi semua data")
            return
    ...
    def _do_login(self, username, password):
        try:
            ...
            self._ui_tasks.push(lambda: self._on_success(result))
    ...
    def _on_success(self, result):
        ...
        self.on_success(result["access_token"], result["username"])
